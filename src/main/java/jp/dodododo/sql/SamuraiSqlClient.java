...
public interface SamuraiSqlClient {
    ...
    <ROW> List<ROW> select(String sql, Class<ROW> as, jp.dodododo.sql.script.Each callback);

    <ROW> List<ROW> select(String sql, Class<ROW> as, Consumer<ROW> callback);

    <ROW> List<ROW> select(String sql, Map<String, Object> arg, Class<ROW> as, jp.dodododo.sql.script.Each callback);
    ...
    List<Map<String, Object>> selectMap(String sql, Map<String, Object> arg, jp.dodododo.sql.script.Each callback);
    ...
    List<Map<String, Object>> selectMap(String sql, jp.dodododo.sql.script.Each callback);
    ...
    <ROW> List<ROW> select(Sql sql, ROW query, jp.dodododo.sql.script.Each callback);
