...
public class BeanResultSetHandlerTest {
	...
	public void testInterface() {
		try {
			...
			assertEquals("This class is invalid, because jp.dodododo.sql.handler.impl.BeanResultSetHandlerTest$Interface is interface.", e.getMessage());
		}
	}
	...
	public void testAbstract() {
		try {
			...
			assertEquals("This class is invalid, because jp.dodododo.sql.handler.impl.BeanResultSetHandlerTest$AbstractClass is abstract.", e.getMessage());
		}
	}
	...
	@Bean(createMethod = "@jp.dodododo.sql.handler.impl.BeanResultSetHandlerTest$AbstractClassHaveFactoryMethod@create()")
