...
public class CreateMethodConstructorTest {
	...
	public static class Emp {
		@Id(value = { @IdDefSet(strategy = Sequence.class, name = "sequence"), @IdDefSet(strategy = Identity.class, db = SQLite.class), @IdDefSet(strategy = Identity.class, db = MySQL.class) }, targetTables = { "emp" })
		public String EMPNO;
